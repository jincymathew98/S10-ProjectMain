                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="assets/images/logo-text.png"  class="dark-logo" width="100%" height="100%" />
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="index.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                                    ...
                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="search-product.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                                    aria-hidden="true"></i><span class="hide-menu">SEARCH</span></a></li>
                        
                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="changeit.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                                    aria-hidden="true"></i><span class="hide-menu">CHANGE</span></a></li>
                        
                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="cart.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                                    aria-hidden="true"></i><span class="hide-menu">My Cart</span></a></li>


                                    
                                    <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="search-result.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                                    aria-hidden="true"></i><span class="hide-menu">Result</span></a></li>
                       

                                   
  <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="logout.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                    ...
                    ?>
                      <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="card h-100">
                           <a class="lightbox" href="#"><img class="img-responsive" src="images/<?php echo $row['product_image']; ?>" width="400px" height="200px"></a>
                          
                          <div class="card-body">
                            <h4 class="card-title text-primary"><?php echo $row['product_name']; ?> </h4>
                            <h5><?php echo number_format($row['product_price'],2); ?>/-</h5>
                            <a href="feedback.html"><U>More details</U></a>
                          </div>
