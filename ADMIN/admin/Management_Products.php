            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="Management_ProductsList.php" aria-expanded="false">
                                <i class="me-3 fa fa-user" aria-hidden="true"></i><span
                                    class="hide-menu">View Products</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="vendor_management.php" aria-expanded="false">
                                <i class="me-3 fa fa-user" aria-hidden="true"></i><span
        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
					...
					<div class="col-md-12">	
						<div class="col-md-6">	
							<form  action="Management_Products_Action.php" method="POST" enctype = "multipart/form-data">
						...
						<div class="col-md-6">	
							<div class="form-group">
							  <label for="ProductSize">Quantity Available:</label>
		...
		<div class="form-group">
			<label for="ProductImage">Product Image:</label>
			     <input type="file" name="ProductImage" accept="image/x-png, image/gif, image/jpg">
							...
							<div class="form-group">
							<button type="submit" style="float: right;" class="btn btn-default" name="btnadd">Submit</button>
							</div>
						</div>
						</form>
					</div>
